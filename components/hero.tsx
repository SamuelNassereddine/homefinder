...
export default function Hero() {
  ...
  return (
    <section className="relative py-20 flex items-center justify-start">
      {/* Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: "url('/placeholder.svg?height=600&width=1200&query=modern+apartment+living+room')",
        }}
      >
